...
export default function StaffTeamDashboard({ user, teamId, onBack, onLogout, readOnly = false }) {
  ...
  return (
    <div style={{ minHeight: "100vh", padding: "1.5rem 1.25rem 4rem", maxWidth: 640, margin: "0 auto" }}>
      ...
      {readOnly && (
        <div style={{ background: COLORS.amberDark, border: `1px solid ${COLORS.amber}`, borderRadius: 10, padding: "8px 14px", marginBottom: 14, marginTop: 8, display: "flex", alignItems: "center", gap: 8 }}>
