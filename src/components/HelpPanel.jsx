...
const SECTIONS_ALL = [
  ...
  {
    title: "Ajustes",
    content: `Configuración del equipo, grupo o atleta.\n\n• Tipo de equipo: cambia entre equipo, grupo o atleta individual.\n• Gestión de plantilla: ve los jugadores/as del roster, márcalos como lesionados o expúlsalos del equipo. Un jugador/a expulsado/a deberá unirse a un nuevo equipo con código.\n• Mover jugador/a: transfiere un jugador/a a otro equipo o grupo tuyo, llevando todos sus datos históricos.\n• Editar convocatoria: gestiona qué jugadores/as están convocados/as para cada partido.\n• Minutos de partido: define los minutos predeterminados para el formulario RPE en días de competición.\n• Hora límite de formularios: establece a qué hora se cierran los formularios de wellness y RPE.\n• Exportar PDF: genera informes en PDF del calendario o datos del equipo.\n• Notificaciones: configura alertas automáticas de wellness y RPE.\n• Zona de peligro: elimina el equipo, grupo o atleta de forma permanente.\n\nPlanificación del mesociclo:\n\nEsta sección permite crear y gestionar plantillas personalizadas de mesociclo para aplicarlas al crear nuevos mesociclos.\n\n• Situaciones Jugadas (Fútbol): plantilla predeterminada de 6 semanas basada en SGJ, SMJ y SRJ. Desde aquí puedes editar los porcentajes de distribución semana a semana para cada tipo de situación, y configurar los minutos por defecto según el número de días de entreno de cada semana.\n• Plantillas personalizadas: crea tus propias plantillas con nombre, emoji, número de semanas, tipos de sesión (con colores y subtipos) y porcentajes de distribución. Al crear un mesociclo podrás seleccionar una de estas plantillas y el sistema generará automáticamente la estructura de semanas.\n• Unidad de distribución: dentro de cada mesociclo con plantilla activa puedes cambiar la unidad de reparto (minutos, repeticiones, metros, km o horas) y el sistema distribuirá el volumen según los porcentajes definidos en la plantilla.`,
  },
  {
